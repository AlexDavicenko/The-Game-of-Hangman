...
green =(38, 156, 14)
normal_red = (255, 0, 0)
letter_font = pygame.font.SysFont("Comic Sans MS", 80)
title_font = pygame.font.SysFont("Comic Sans MS", 200)
option_font = pygame.font.SysFont("Comic Sans MS", 60)
guessed_font = pygame.font.SysFont("Comic Sans MS", 70)
guess_font = pygame.font.SysFont("Comic Sans MS", 100)
left_font = pygame.font.SysFont("Comic Sans MS", 180)
git_font = pygame.font.SysFont('Comic Sans MS', 30)
...
def single_player():
    ...
    alphabet = string.ascii_uppercase
    running = True
    game = Hangman(dictionary="english_words.txt")
    while running:
        if len(game.guess_wrong) >=10:
            running = False
            loss_screen(game)
